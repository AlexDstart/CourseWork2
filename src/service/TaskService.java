...
public class TaskService {
    ...
    public void mainWindow(Map<Integer, DateInterfaces> mapOfTasks, List<DateInterfaces> removedTasks) {
    ...
    public void newTask(Map<Integer, DateInterfaces> mapOfTasks) {
        Type type = null;
        String choice;
        do {
            System.out.print("""
    ...
    public void makeChoice(Task task, Map<Integer, DateInterfaces> mapOfTasks) {
        mapOfTasks.put(task.getId(), (DateInterfaces) task);
    }

    public void showCurrentTasks(Map<Integer, DateInterfaces> mapOfTasks) {
        mapOfTasks.entrySet().stream()
                .filter(task -> task.getValue().appearsIn(LocalDate.now()))
                .forEach(s -> System.out.println(s.getValue()));
    }

    public void editTask(Map<Integer, DateInterfaces> mapOfTasks) {
        int id = -1;
        do {
            System.out.print("Введите значение id задачи для корректировки: ");
            try {
    ...
    public void showTasksOfDate(Map<Integer, DateInterfaces> mapOfTasks) {
        LocalDate date = null;
        do {
    ...
    public void showAllTasksByDate(Map<Integer, DateInterfaces> mapOfTasks) {
        Map<Integer, DateInterfaces> sortedByDate = mapOfTasks.entrySet().stream()
    ...
    public void deleteTask(Map<Integer, DateInterfaces> mapOfTasks, List<DateInterfaces> removedTasks) {
        int id = -1;
        do {
    ...
    public void showDeletedTasks(List<DateInterfaces> removedTasks) {
